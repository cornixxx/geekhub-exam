...
function _s_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'footer-widget', '_s' ),
		'id'            => 'footer-widget',
		'description'   => '',
		'before_widget' => '<div id="%1$s" class="footer-wg">',
		'after_widget'  => '</div>',
...
/* Customizer */
function cornix_customize_register( $wp_customize ) {
	$wp_customize->add_section( 'social_links' , array(
		'title'      => __( 'Social links', 'cornix' ),
		'priority'   => 30,
	) );
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'social_links_google', array(
		'label'        => __( 'Google', 'cornix' ),
		'section'    => 'social_links',
		'settings'   => 'social_links_google',
	) ) );
}
add_action( 'customize_register', 'cornix_customize_register' );
...
function _s_scripts() {
	...
	wp_enqueue_script( 'jquery.flexslider-min', get_template_directory_uri() . '/js/jquery.flexslider-min.js', array('jquery'), '2.6.0', true );
